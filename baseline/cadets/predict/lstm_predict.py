...
if __name__ == '__main__':
    ...
    # Load LSTM Model
    lstm_model = load_model(f'/behavior_baseline/baseline/cadets/model/{embedding_model}_lstm_model.keras')
    ...
    x_malicious = np.expand_dims(x_malicious, axis=1)
    y_pred_malicious = lstm_model.predict(x_malicious)
