...
def get_word_vector(words, model):
    ...
    for i, word in enumerate(words):
        ...
        # position_vector = get_position_vector(i, max_position_size)
        # combined_vector = np.concatenate((vector, position_vector))  
...
if __name__ == '__main__':
    ...
    train_data_path = f'/behavior_baseline/baseline/cadets/data/fasttext/train_data.npy'
    test_data = f'/behavior_baseline/baseline/cadets/data/test_data.csv'
    test_data_path = f'/behavior_baseline/baseline/cadets/data/fasttext/test_data.npy'
    malicious_data = f'/behavior_baseline/baseline/cadets/data/malicious_data.csv'
    malicious_data_path = f'/behavior_baseline/baseline/cadets/data/fasttext/malicious_data.npy'
    # event_data = f'/Datasets/cadets/e3_cadets_preparation_event_8.csv'
    # event_data_path = f'/behavior_baseline/baseline/cadets/data/fasttext/e3_cadets_preparation_event_8.npy'
    ...
    batch_encode_events(train_events, FASTTEXT, batch_size, train_data_path)
    training_end_time = time.time()
    batch_encode_events(test_events, FASTTEXT, batch_size, test_data_path)
