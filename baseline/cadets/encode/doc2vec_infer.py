...
if __name__ == '__main__':
    ...
    batch_encode_events(train_events, DOC2VEC, batch_size, train_data_path)
    training_end_time = time.time()
    batch_encode_events(test_events, DOC2VEC, batch_size, test_data_path)
    encode_end_time = time.time()
    batch_encode_events(malicious_events, DOC2VEC, batch_size, malicious_data_path)
